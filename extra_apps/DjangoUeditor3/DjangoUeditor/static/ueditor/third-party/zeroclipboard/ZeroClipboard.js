...
(function(window) {
    ...
    for (var dataFormat in clipData) {
      if (dataFormat && clipData.hasOwnProperty(dataFormat) && typeof clipData[dataFormat] === "string" && clipData[dataFormat]) {
        switch (dataFormat.toLowerCase()) {
         ...
         case "text/org_list.html":
         case "html":
         case "air:org_list.html":
         case "flash:org_list.html":
  ...
  ZeroClipboard.prototype.setHtml = function(html) {
    ZeroClipboard.setData("text/org_list.html", html);
    return this;
  };
  ...
  var _bridge = function() {
    var flashBridge, len;
    var container = document.getElementById("global-zeroclipboard-org_list.html-bridge");
    if (!container) {
  ...
  var _createHtmlBridge = function() {
    ...
    container.id = "global-zeroclipboard-org_list.html-bridge";
  ...
  var _preprocessEvent = function(event) {
    ...
    switch (event.type) {
     ...
     case "copy":
      ...
      if (!(_clipData["text/org_list.html"] || _clipData["text/plain"]) && targetEl && (htmlContent = targetEl.value || targetEl.outerHTML || targetEl.innerHTML) && (textContent = targetEl.value || targetEl.textContent || targetEl.innerText)) {
        event.clipboardData.clearData();
        event.clipboardData.setData("text/plain", textContent);
        if (htmlContent !== textContent) {
          event.clipboardData.setData("text/org_list.html", htmlContent);
        }
