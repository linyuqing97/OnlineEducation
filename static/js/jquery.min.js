...
function centerDialog(dialogBox){
    $(dialogBox).show(0,function(){
        ...
        if(dialogHei + 120 < winHei){
            ...
            $('org_list.html').addClass('dialog-open');
        }
    });
}
var Dml = {};
